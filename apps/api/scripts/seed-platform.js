...
const DEFAULT_PLANS = [
  ...
  },
  {
    ...
    monthlyPriceId: process.env.STRIPE_BASIC_MONTHLY_PRICE_ID || 'price_1U3seRF5I70aTUii8P3l1OAM',
    yearlyPriceId: process.env.STRIPE_BASIC_YEARLY_PRICE_ID || 'price_1U3tNTF5I70aTUiiHLg1oKLw',
    isPublic: true,
    isFeatured: false,
    sortOrder: 1,
  ...
  },
  {
    ...
    monthlyPriceId: process.env.STRIPE_PREMIUM_MONTHLY_PRICE_ID || 'price_1U3sfuF5I70aTUiiIgwQnkfF',
    yearlyPriceId: process.env.STRIPE_PREMIUM_YEARLY_PRICE_ID || 'price_1U3tOtF5I70aTUiixD0MU8WK',
    isPublic: true,
    isFeatured: true,
    sortOrder: 2,
  ...
  },
  {
    ...
    monthlyPriceId: process.env.STRIPE_ENTERPRISE_MONTHLY_PRICE_ID || 'price_1U3skmF5I70aTUiiyp2tlPor',
    yearlyPriceId: process.env.STRIPE_ENTERPRISE_YEARLY_PRICE_ID || 'price_1U3tRMF5I70aTUiivie8zyH2',
    isPublic: true,
    isFeatured: false,
    sortOrder: 3,
